...
urlpatterns = [
    ...
    path('review/ticket/update/<int:ticket_id>', views.update_ticket, name='update_ticket'),
    path('review/ticket/delete/<int:ticket_id>', views.delete_ticket, name='delete_ticket'),
    path('review/create/', views.create_review, name='create_review'),
    path('review/create/<int:ticket_id>', views.create_review_from_ticket, name='create_review_from_ticket'),
